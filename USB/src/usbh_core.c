...
{
	  //LCD_PutString( 5, pos, "USB_OTG_BSP_Init... " );
  /* Hardware Init */
  USB_OTG_BSP_Init(pdev);  
  	  //LCD_PutString( 5, NEXT_LINE, "USB_OTG_BSP_ConfigVBUS... " );
  /* configure GPIO pin used for switching VBUS power */
  USB_OTG_BSP_ConfigVBUS(0);  
  
  	  //LCD_PutString( 5, NEXT_LINE, "USBH_DeInit... " );
  ...
  pdev->host.port_cb->DisconnStatus = 0; 
  	  ...
  	  //LCD_PutString( 5, NEXT_LINE, "HCD_Init... " );
  /* Start the USB OTG core */     
   HCD_Init(pdev , coreID);
   
   	   //LCD_PutString( 5, NEXT_LINE, "phost->usr_cb->Init()" );
  /* Upon Init call usr call back */
  phost->usr_cb->Init();
  
  	  //LCD_PutString( 5, NEXT_LINE, "USB_OTG_BSP_EnableInterrupt... " );
  /* Enable Interrupts */
